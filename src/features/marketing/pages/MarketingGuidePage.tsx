...
const CHAPTERS: Chapter[] = [
  {
    ...
    blocks: [
      ...
      { type: 'ol', items: [
        ...
        'Every validated submission earns an entry into the current monthly prize draw.',
      ...
      { type: 'p', text: "It's to help you increase customer engagement, encourage repeat business, and generate measurable returns from every Winnbell campaign." },
  ...
  },
  {
    ...
    blocks: [
      { type: 'p', text: "Successful marketing isn't just about attracting customers, it's about influencing behavior." },
      { type: 'p', text: "The most effective businesses understand that small changes in customer behavior can lead to meaningful increases in revenue. Encouraging a customer to spend a little more, visit a little more often, or choose your business over a competitor doesn't happen by chance. It happens because people naturally respond to certain psychological triggers." },
      { type: 'p', text: 'Winnbell is built around several of these well-established principles of behavioral science.' },
      { type: 'h2', text: 'People Overvalue Small Chances to Win' },
      { type: 'p', text: 'One of the foundations of Winnbell comes from the work of Nobel Prize-winning psychologist **Daniel Kahneman** and **Amos Tversky**.' },
      { type: 'p', text: "Their research showed that people don't always think about probabilities in a purely mathematical way. When there's a meaningful prize involved, people naturally place much more value on a small chance of winning than the actual odds would suggest." },
      { type: 'p', text: 'This helps explain why millions of people choose to buy lottery tickets despite the extremely low chances of winning. **While Winnbell is not a lottery, the underlying psychological principle is similar**, the possibility of winning something meaningful is often far more motivating than receiving a small guaranteed reward, such as a discount.' },
      { type: 'p', text: 'Instead of simply offering customers another coupon or promotion, Winnbell gives them something more exciting: a chance to win a significant monthly prize. That excitement encourages engagement, repeat visits, and can even influence where customers choose to shop.' },
      { type: 'h2', text: 'Progress Creates Motivation' },
      { type: 'p', text: 'Another well-established behavioral principle is known as the **Goal Gradient Effect**.' },
      { type: 'p', text: 'Researchers have found that people naturally become more motivated as they get closer to achieving a goal. This is why loyalty cards, airline reward programs, and fitness challenges become increasingly engaging over time.' },
      { type: 'p', text: 'The same principle applies within Winnbell.' },
      { type: 'p', text: 'As customers accumulate entries throughout the month, many become increasingly motivated to continue participating until they reach the monthly maximum. Every additional qualifying purchase feels like another step toward completing their personal goal.' },
      { type: 'p', text: 'Instead of every visit existing in isolation, customers begin thinking about their progress over the entire campaign.' },
      { type: 'h2', text: 'Customers Think in Perceived Value, Not Just Dollars' },
      { type: 'p', text: "People don't evaluate purchases using mathematics alone." },
      { type: 'p', text: 'Behavioral economists describe this as **mental accounting**, the tendency to assign different emotional values to the same amount of money depending on the situation.' },
      { type: 'p', text: 'For example, spending an extra $5 simply to buy another product may feel unnecessary.' },
      { type: 'p', text: 'Spending that same $5 to qualify for a chance to win a big prize often feels very different.' },
      { type: 'p', text: "The transaction hasn't changed, but the perceived value has." },
      { type: 'p', text: 'This is why choosing the right qualifying threshold is one of the most powerful tools available to participating businesses.' },
      { type: 'h2', text: 'Anticipation Is Part of the Reward' },
      { type: 'p', text: "Winning isn't the only source of excitement." },
      { type: 'p', text: 'Research has shown that people often experience positive emotions simply by anticipating a future reward. Thinking about what they would do if they won can be enjoyable long before the draw ever takes place.' },
      { type: 'p', text: 'Every qualifying purchase gives customers another reason to imagine the possibility of winning, keeping your business associated with positive emotions long after they leave your store.' },
    ],
  },
  {
    id: 'entry-cap',
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'ul', items: [
        ...
        '**Protect sensitive information.** Before uploading your sample, ensure it does not display customer names, payment card numbers, or any other confidential information. If necessary, redact or cover this information before creating the sample.',
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'p', text: 'A simple mention of Winnbell during checkout can dramatically increase participation and engagement rates. It reminds customers about the opportunity to qualify for the monthly prize and encourages them to consider adding one more item or service to reach the qualifying threshold.' },
