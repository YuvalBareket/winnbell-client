...
const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    blocks: [
      { type: 'p', text: "Daniel Kahneman and Amos Tversky's Prospect Theory showed that people do not always evaluate probabilities in a purely mathematical way. In particular, people can give disproportionately high psychological weight to small chances of receiving large rewards. Their work became a foundation of behavioral economics and later helped earn Kahneman the Nobel Memorial Prize in Economic Sciences." },
      { type: 'p', text: 'This helps explain why a chance to win a meaningful prize can feel more exciting and motivating than a small guaranteed discount.' },
      { type: 'p', text: 'Consider the difference between:' },
      { type: 'p', text: '"Save $2 today."' },
      { type: 'p', text: 'and' },
      { type: 'p', text: '"Get a chance to win a major cash prize."' },
      { type: 'p', text: 'The discount is guaranteed, but its value is limited and easy to ignore. A meaningful prize creates a much larger possible outcome, and that possibility can make the incentive feel more valuable than its mathematical odds alone would suggest.' },
      { type: 'h2', text: 'Why Winnbell Can Make This More Efficient' },
      { type: 'p', text: 'Traditional incentives usually have a simple economic limitation: the business pays for the value it gives away.' },
      { type: 'p', text: 'If a business gives customers $5 off, it gives up $5. Give that reward to hundreds or thousands of customers, and the cost adds up quickly.' },
      { type: 'p', text: 'Winnbell changes that structure.' },
      { type: 'p', text: 'Instead of every business funding thousands of small individual rewards, many businesses share one meaningful prize campaign.' },
      { type: 'p', text: 'That shared structure allows each participating business to contribute only a small portion of the economics behind the campaign while giving its customers access to a prize far larger than the business would normally be able to offer on its own.' },
      { type: 'p', text: 'So instead of paying dollar-for-dollar to create customer value, Winnbell is designed to create leverage: a stronger perceived incentive at a lower cost to the individual business.' },
      { type: 'p', text: 'That is what changes the economics of incentives.' },
      { type: 'p', text: 'Large brands have understood the power of major prize promotions for decades and have used sweepstakes to create attention, excitement, and customer action. But meaningful prizes, legal requirements, and campaign administration have traditionally made these promotions difficult for small and medium-sized businesses to justify on their own.' },
      { type: 'p', text: "Winnbell's shared model brings that same type of powerful incentive within reach of SMBs." },
    ],
  },
  {
    id: 'entry-cap',
    kicker: 'Setup',
    title: 'Choosing the Right Participation Capacity',
    blocks: [
      { type: 'p', text: 'Your Participation Capacity determines the maximum number of entries that can be activated through your business during a campaign.' },
      { type: 'p', text: 'If your Participation Capacity is exhausted before the campaign ends, customers will no longer be able to receive entries through your business, and your business will no longer appear as an active participating location until the next campaign begins.' },
      { type: 'p', text: "If you're unsure how much capacity you'll need, we recommend starting with a smaller Participation Capacity. After your first campaign, you'll have a much better understanding of your customer participation and can easily increase your Participation Capacity for future campaigns if needed." },
      { type: 'p', text: "Keep in mind that customer participation often grows over the first few campaigns as your customers become more familiar with Winnbell. If your Participation Capacity is nearly exhausted during your first campaign, it's usually a good indication that you should consider upgrading it for your next campaign to avoid limiting future growth." },
      { type: 'callout', text: 'Review your campaign analytics after each campaign and adjust your Participation Capacity until you find the level that best matches your business.' },
    ],
  },
  {
    id: 'profile',
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'p', text: 'Monitor your campaign performance by reviewing metrics under the analytics section such as:' },
      { type: 'ul', items: [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'p', text: "We recommend posting during the campaign more than once. A post at the beginning of the campaign creates awareness, while reminder posts during the campaign help keep Winnbell fresh in your customers' minds and may encourage repeat visits." },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'ul', items: [
        ...
        "**Using a Participation Capacity that's too small.** If you consistently reach your cap early, consider increasing it for future campaigns.",
