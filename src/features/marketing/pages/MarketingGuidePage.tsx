...
const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'p', text: 'Winnbell uses this principle by giving customers the opportunity to participate in a significant monthly prize campaign instead of offering only another small discount or coupon. Results will vary, but the possibility of winning can make the promotion feel more exciting, noticeable, and worth engaging with.' },
      ...
      { type: 'p', text: 'When customers can track their entries during the campaign, each new qualifying visit feels connected to the entries they have already collected. Instead of every visit standing on its own, customers can see their participation building throughout the month.' },
