...
const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'p', text: "Customers may also enjoy imagining what they would do if they won and following the campaign as the draw gets closer. That feeling of anticipation can help keep Winnbell, and the participating businesses connected to it, in the customer's mind throughout the campaign." },
    ],
  },
  {
    id: 'entry-cap',
